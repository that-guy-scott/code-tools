...
export const CONNECTION_BUILDERS = {
  ...
  postgres: (): string => 
    `postgresql://${DATABASE_DEFAULTS.POSTGRES_USER}:${DATABASE_DEFAULTS.POSTGRES_PASSWORD}@${NETWORK_DEFAULTS.POSTGRES_HOST}:${CONFIG_DEFAULTS.POSTGRES_PORT}/${DATABASE_DEFAULTS.POSTGRES_DATABASE}`,
} as const;
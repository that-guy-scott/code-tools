INSERT INTO tech_specs (
    ...
    'CLI Tool',
    'draft',
    'Universal command-line interface supporting multiple LLM providers (Ollama, Gemini, OpenAI, Anthropic) with integrated Model Context Protocol (MCP) server tooling capabilities.',
    $spec$# Universal LLM CLI v2 Technical Specification
...
**Next Review:** Implementation completion$spec$,
    'Universal LLM CLI with provider abstraction, MCP integration, and automation-focused design using SOLID OOP principles.',
    '["Multi-provider support", "MCP server integration", "Universal tool calling", "Dynamic model discovery", "Flexible configuration", "Multiple output formats"]'::jsonb,
    '["Node.js 18+", "commander", "chalk", "dotenv", "ollama", "@google/generative-ai", "MCP servers"]'::jsonb,
    '/home/owner/repo/code-tools/llmv2.tech.spec.md'
);